...
export default function ChatTab() {
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-cyan-600 via-blue-600 to-cyan-700 rounded-3xl p-8 text-white shadow-2xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold mb-2">AI Chat Intelligence</h1>
            <p className="text-cyan-100">Context-aware conversations powered by AI</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 text-center">
            ...
            <p className="text-sm text-cyan-100">Messages</p>
          </div>
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 text-center">
            <Zap className="w-6 h-6 text-green-400 mx-auto mb-2" />
            <p className="text-2xl font-bold">99.8%</p>
            <p className="text-sm text-cyan-100">Accuracy</p>
          </div>
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 text-center">
            <Shield className="w-6 h-6 text-yellow-400 mx-auto mb-2" />
            <p className="text-2xl font-bold">20+</p>
            <p className="text-sm text-cyan-100">Languages</p>
          </div>
        </div>
      </div>
